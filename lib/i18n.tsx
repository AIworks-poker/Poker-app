...
const en = {
  ...
  suggest: 'Suggest a template', suggestCopied: 'Link copied — send it to the dealer and it can become a template.',
  suggestFailed: 'Could not copy the link.', suggestLoaded: 'Suggested setup loaded.',
...
const cz: Dict = {
  ...
  suggest: 'Navrhnout šablonu', suggestCopied: 'Odkaz zkopírován — pošlete ho dealerovi a může se z něj stát šablona.',
  suggestFailed: 'Odkaz se nepodařilo zkopírovat.', suggestLoaded: 'Navržené nastavení načteno.',
...
const nl: Dict = {
  ...
  suggest: 'Sjabloon voorstellen', suggestCopied: 'Link gekopieerd — stuur hem naar de dealer en het kan een sjabloon worden.',
  suggestFailed: 'Link kopiëren mislukt.', suggestLoaded: 'Voorgestelde instelling geladen.',
